...
<!--This writeup isnt great, we should improve it together as a team-->
...
- Typescript is a super-set of Javascript, with enforced static typing, this makes it easier to identify bugs due to faulty typing, which is common when writing Javascript.
...
- Allows for a more unified codebase between front-end and back-end, fits better with our monolith architecture
...
- PostgreSQL is a powerful, open-source relational database with strong community support and a wide range of features
...
- Chose Bun over NPM/Yarn/PNPM due to its speed and integrated features, which can streamline our development workflow
...
- happy-dom provides a lightweight DOM implementation for testing React components in a Node.js environment
...
- Podman/Docker allows for containerization of the application, making it easier to deploy and manage dependencies
